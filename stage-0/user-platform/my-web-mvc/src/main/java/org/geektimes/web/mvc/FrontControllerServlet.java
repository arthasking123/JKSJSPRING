...
public class FrontControllerServlet extends HttpServlet {
        ...
        for (Controller controller : ServiceLoader.load(Controller.class)) {
            ...
            for (Method method : publicMethods) {
                ...
                if (pathFromMethod != null) {
                    System.out.println("mapping:" + requestPath + pathFromMethod.value() + " method:" + method.getName());
                    handleMethodInfoMapping.put(requestPath + pathFromMethod.value(),
                            new HandlerMethodInfo(requestPath + pathFromMethod.value(), method, supportedHttpMethods));
                }
            }
            System.out.println("mapping:" + requestPath + " controller:" + controller.toString());
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)
        ...
        if(actionStartIndex == -1)
            return;
        Controller controller = controllersMapping.get(requestMappingPath.substring(0,actionStartIndex));
